...
public class ToolsToolbar extends Toolbar {
    ...
    public ToolsToolbar(Context context) {
        super(context);
        resolveAttribute(context, null, R.attr.toolbarStyle);
    }

    public ToolsToolbar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        resolveAttribute(context, attrs, R.attr.toolbarStyle);
    }

    public ToolsToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
